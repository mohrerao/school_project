    ...
    <form id="form_119127" class="appnitro" method="post" action="">
        ...
        <ul>
            <li id="li_2">
                ...
                <div>
                    <input id="section_name" name="section_name" class="element text medium" type="text" maxlength="255"
                           value=""/>
                </div>
            </li>
            <li id="li_3">
                ...
                <div>
                    <select class="element select medium" id="class_id" name="class_id" value= <?php ?>>
                        <?php
